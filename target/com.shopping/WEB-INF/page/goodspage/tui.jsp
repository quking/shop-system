				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/tui.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/tui.png"><img src="/images/tui.png" alt="细节展示放大镜特效" rel="/images/tui.png" class="jqzoom" /></a>
							</div>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								良品铺子小鸡腿奥尔良鸡腿零食真空鸡翅根肉类熟食卤味小吃小包装
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">24.90</b>  </dd>
								</li>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(11)">加入收藏</a>
								</div>
							</li>
							<li>
