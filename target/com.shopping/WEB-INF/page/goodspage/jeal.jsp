				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/jeal.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/jeal.png"><img src="/images/jeal.png" alt="细节展示放大镜特效" rel="/images/jeal.png" class="jqzoom" /></a>
							</div>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								良品铺子果肉果冻大礼包芒果布丁夏天零食椰果水果蓝莓山竹多口味
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">13.90</b>  </dd>
								</li>
							...
							<ul class="tm-ind-panel">
								...
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">16015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
									<div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">5640</span></div>
								</li>
							</ul>
							<div class="clear"></div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">奶昔味<i></i></li>
															<li class="sku-line selected">酸奶味<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
												...
												<div class="theme-signin-right">
													...
													<div class="text-info">
														<span class="J_Price price-now">¥33.90</span>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(12)">加入收藏</a>
								</div>
							</li>
							<li>
