				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/lenovo.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/lenovo.png"><img src="/images/lenovo.png" alt=" " rel="/images/lenovo.png" class="jqzoom" /></a>
							</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								Lenovo/联想 小新 air 12 超轻薄笔记本电脑 12.2英寸IPS高清屏
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>活动价</dt>
									<dd><em>¥</em><b class="sys_item_price">4445.90</b>  </dd>
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">5588.00</b></dd>
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">853</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">2015</span></div>
								</li>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														<div class="cart-title">付款方式</div>
														<ul>
															<li class="sku-line selected">蚂蚁花呗<i></i></li>
