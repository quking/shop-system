				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/song.png" title="pic" />
								</li>
								<li>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/song.png"><img src="/images/song.png" alt="东北红松" rel="/images/song.png" class="jqzoom" /></a>
							</div>
						...
						<div class="tb-detail-list">
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">28050</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">336015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
									<div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">8640</span></div>
								</li>
							</ul>
							<div class="clear"></div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">东北红松218g/袋<i></i></li>
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">手袋单人盒<i></i></li>
												...
												<div class="theme-signin-right">
													...
													<div class="text-info">
														<span class="J_Price price-now">¥56.90</span>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(1)">加入收藏</a>
								</div>
							</li>
							<li>
