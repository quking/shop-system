				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/duck.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/duck.png"><img src="/images/duck.png" alt="鸭脖" rel="/images/duck.png" class="jqzoom" /></a>
							</div>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								良品铺子麻辣鸭脖子 甜辣味真空小包装香辣卤味零食休闲小吃熟食
							</h1>
						</div>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(9)">加入收藏</a>
								</div>
							</li>
							<li>
