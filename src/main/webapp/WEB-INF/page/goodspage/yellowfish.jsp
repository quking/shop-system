				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/huangyu.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/huangyu.png"><img src="/images/huangyu.png" alt="小黄鱼" rel="/images/huangyu.png" class="jqzoom" /></a>
							</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								良品铺子香酥小黄鱼舟山特产香辣味小吃小黄鱼干零食即食海鲜袋装
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">18.90</b>  </dd>
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">38.00</b></dd>
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">月销量</span><span class="tm-count">12015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">36015</span></div>
								</li>
								<li class="tm-ind-item tm-ind-reviewCount canClick tm-line3">
									<div class="tm-indcon"><span class="tm-label">累计评价</span><span class="tm-count">15640</span></div>
								</li>
							</ul>
							<div class="clear"></div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">香辣味<i></i></li>
															<li class="sku-line selected">五香味<i></i></li>
															<li class="sku-line selected">XO酱味<i></i></li>
															<li class="sku-line selected">黑胡椒味<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(7)">立即购买</a>
								</div>
							</li>
							<li>
