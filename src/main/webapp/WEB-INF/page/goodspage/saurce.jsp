				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/saurce.png" title="pic" />
								</li>
								<li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/saurce.png"><img src="/images/saurce.png" alt="小香肠" rel="/images/saurce.do" class="jqzoom" /></a>
							</div>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								良品铺子肉枣小香肠好吃的零食小吃迷你烤肠肉类熟食即食香辣肉脯
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">29.90</b>  </dd>
								</li>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-buy theme-login">
									<a id="LikBuy" title="点此按钮到下一步确认购买信息" onclick="addtocollection(10)">加入收藏</a>
								</div>
							</li>
							<li>
