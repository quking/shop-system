				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/images/choto.png" title="pic" />
								</li>
								<li>
									<img src="/images/choto.png" />
								</li>
								<li>
									<img src="/images/choto.png" />
								</li>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/images/choto.png"><img src="/images/choto.png" alt="" rel="/images/choto.png" class="jqzoom" /></a>
							</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-hd">
							<h1>
								德芙巧克力礼盒装 送女友生日礼物 520巧克力情人节 创意diy礼品
							</h1>
						</div>
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>活动价</dt>
									<dd><em>¥</em><b class="sys_item_price">59.90</b>  </dd>
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">188.00</b></dd>
								</li>
								<div class="clear"></div>
							</div>
											...
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<ul>
															<li class="sku-line selected">草莓夹心<i></i></li>
															<li class="sku-line selected">牛奶夹心<i></i></li>
															<li class="sku-line selected">香草夹心<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
														<div class="cart-title">可选规格</div>
														<ul>
															<li class="sku-line selected">情侣套餐<i></i></li>
															<li class="sku-line selected">家庭套餐<i></i></li>
														</ul>
													</div>
													<div class="theme-options">
												...
												<div class="theme-signin-right">
													...
													<div class="text-info">
														<span class="J_Price price-now">¥3339.00</span>
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="javascript:warnning();">加入购物车</a>
								</div>
							</li>
						</div>
